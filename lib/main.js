...
// Ensure correct import path for dbClient
...
_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        console.log('Redis Client Alive:', _redis["default"].isAlive());
      ...
      case 4:
        ...
        _context2.t0.log.call(_context2.t0, 'Value of myKey:', _context2.t1);
        _context2.next = 8;
      ...
      case 11:
        ...
        _context2.t2.log.call(_context2.t2, 'New value of myKey:', _context2.t3);
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.t0.log.call(_context.t0, 'Value of myKey after 10 seconds:', _context.t1);
              case 5:
              case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              if (attempts >= 10) {
                ...
                _checkConnection(); // Retry connection check
              } else {
...
_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        console.log('MongoDB Client Alive:', _db["default"].isAlive());
      ...
      case 3:
        ...
        console.log('MongoDB Client Alive after waiting:', _db["default"].isAlive());
        _context4.t0 = console;
        _context4.next = 7;
        return _db["default"].nbUsers();
      case 7:
        _context4.t1 = _context4.sent;
        _context4.t0.log.call(_context4.t0, 'Number of Users:', _context4.t1);
        _context4.t2 = console;
        _context4.next = 12;
        return _db["default"].nbFiles();
      case 12:
        _context4.t3 = _context4.sent;
        _context4.t2.log.call(_context4.t2, 'Number of Files:', _context4.t3);
      case 14:
      case "end":
